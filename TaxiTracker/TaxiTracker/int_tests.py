...
class PutPostDeleteTestUser(TestCase):
    ...
    def test_put_updates_vehicle(self):
        ...
        self.assertEqual(self.vehicle.plate_number, "X111XX178")
        self.assertEqual(self.vehicle.odometer, 100)
        self.assertEqual(self.vehicle.price, 1200000)
        self.assertEqual(self.vehicle.color, "Красный")
